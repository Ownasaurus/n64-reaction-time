...
be32(rom, 0x10, 0);
be32(rom, 0x14, 0);
const title = "REACTION TIME RDP ".padEnd(20, " ");
...
await writeFile(new URL("./build/reaction_time_gliden64.z64", import.meta.url), rom);
...
console.log(`Built reaction_time_gliden64.z64: ROM=${rom.length}, program=${raw.length}, DMA=${paddedLoadSize}, CRC=${crc1.toString(16).padStart(8,"0")}/${crc2.toString(16).padStart(8,"0")}`);
